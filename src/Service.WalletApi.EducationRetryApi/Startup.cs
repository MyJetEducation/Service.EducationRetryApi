...
using Service.WalletApi.EducationRetryApi.Modules;

namespace Service.WalletApi.EducationRetryApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "retry");
